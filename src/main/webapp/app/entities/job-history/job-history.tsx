      ...
      <div>
        <h2 id="job-history-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="jhipsterdemoApp.jobHistory.home.createLabel">Create a new Job History</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterdemoApp.jobHistory.home.search')}
                  />
